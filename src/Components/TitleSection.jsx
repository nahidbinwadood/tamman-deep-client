...
const TitleSection = ({ title, header, highlightedHeader, description }) => {
  return (
    <div className="flex items-center justify-center flex-col">
      ...
      <h2 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold pt-3 md:pt-4 text-center">
        {header && header}
      ...
      <p className="pt-3 md:pt-5 lg:text-lg lg:w-2/3 mx-auto text-center text-textColor">
