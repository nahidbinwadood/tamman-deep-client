...
const ProfileAction = () => {
  ...
  return (
    <div className="flex items-center justify-center">
      ...
      <div className="flex flex-col gap-10 items-center justify-center mx-auto min-w-[450px] py-10  rounded-xl bg-gradient-to-t from-[rgba(35,192,182,0.80)] to-[rgba(17,109,255,0.80)] text-white">
        <div className="pt-10">
